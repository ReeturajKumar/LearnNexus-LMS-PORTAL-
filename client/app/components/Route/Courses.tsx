...
const Courses = (props: Props) => {
  ...
  return (
    <div className={`w-[90%] 800px:w-[80%] m-auto`}>
      <h1 className="text-center font-poppins text-[25px] leading-[35px]sm:text-3xl lg:text-4xl dark:text-white 800px:!leading-[60px] mt-6 text-[#000] font-[700] tracking-tight">
      Expand Your Career{" "}
<span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent pl-1">Opportunities</span>
<br />
Unlock New Paths With Our Courses
