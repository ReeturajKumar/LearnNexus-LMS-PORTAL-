...
import nexgenie from "../../../public/assets/nexgenie.png";
import user_avatar from "../../../public/assets/user_avatar.png";
...
const Chatbot: FC = () => {
  ...
  return (
    <div className="chatbot">
      ...
      >
        <Image src={nexgenie} alt="Chatbot icon" width={50} height={50} />
      </div>

      {isOpen && (
        <div className="chat-window">
          <div className="chat-header">
            <Image src={nexgenie} alt="icon" width={30} height={30} />
