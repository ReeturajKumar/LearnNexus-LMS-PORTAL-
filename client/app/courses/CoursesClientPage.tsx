          ...
          <div className="mt-20">
            <div className="w-[95%] 800px:w-[85%] m-auto min-h-screen">
              <Heading
                ...
                description={
                  'LearnNexus is a platform that provides a wide range of courses and resources for learning and self-improvement.'
                }
              ...
              <div className="w-full flex items-center flex-wrap">
                <div
                  ...
                  } m-3 px-3 rounded-[30px] flex items-center justify-center cursor-pointer font-poppins`}
              ...
              {courses && courses.length === 0 && (
                <p className={`${styles.label} justify-center min-h-[50vh] flex items-center`}>
                  {search
                    ? `No course found!`
                    : 'No course found in this category. Please choose another category.'}
                </p>
              )}
              <br />
              <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {courses &&
                  courses.map((item: any, index: number) => <CourseCard key={index} item={item} />)}
              </div>
              <br />
              <br />
            </div>
